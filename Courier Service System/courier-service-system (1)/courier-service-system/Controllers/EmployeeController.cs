...
namespace courier_service_system.Controllers
{
    public class EmployeeController : Controller
    {
        ...
        public ActionResult Employees(string id)
        {
            ...
            List<Employee> employees = employeeRepository.GetEmployeesForOffice(division,"Hello");
        ...
        public ActionResult Approve(string id)
        {
            if (Session["uname"] != null)
            {
                ...
                mailModelService.DeleteMail(Convert.ToInt32(Session["MailId"]));
                requestUpdateService.Delete(id);
                Session["Count"] = requestUpdateService.getRowCount();
                return RedirectToAction("Inbox", "SendMailer");
            }
            return RedirectToAction("Index", "Home");
        }
