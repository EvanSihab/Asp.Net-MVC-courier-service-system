...
namespace CSSRepository
{
    public class EmployeeRepository : Repository<Employee>, IEmployeeRepository
    {
        ...
        public List<Employee> GetEmployeesForOffice(string division, string officeId)//new add
        {
            return this.context.Employees.Where(oh => oh.OfficeId.Equals(officeId)).ToList();
        }
